...
<body>
    <div class="wrapper">
        ...
        <div class="banner">
            <img src="Image/banneradmin.png" alt="Food Store Banner" width="100%">
        </div>
        ...
        <div class="about-us">
            ...
            <div class="about-image">
                <img src="Image/Fastfood2.jpg" alt="Delicious Food">
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="right">
                <?php
                $connect = mysqli_connect('localhost', 'root', '', 'se07102_sdlc', port:3307);
                if (!$connect) {
        ...
        <footer class="footer">
            <div class="footer-container">
                ...
                <div class="footer-section contact">
                    ...
                    <p>Address: 10 Rue de Rivoli, 75001 Paris, France</p>
                </div>
